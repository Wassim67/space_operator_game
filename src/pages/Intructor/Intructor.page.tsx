...
interface Intructor {
  navigation: NavigationProp<RootStackParamList, "Intructor">;
}

export const Intructor: React.FC<Intructor> = ({ navigation }) => {
...
<CustomView flexDirection="row" justifyContent="space-between" alignItems="center">
      ...
      <CustomText2 bold text="Votre role : Instructeur" color="white" textSize="medium"/>
        ...
        <CustomText2 text="Votre description :" bold color="black" textSize="medium"/>
        </CustomView>
        <CustomText2 text="Mettre Variable description" bold color="black" textSize="large"/>
          </CustomView>
